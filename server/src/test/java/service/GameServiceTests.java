...
public class GameServiceTests {
    ...
    public void createGameTwice(){
        ...
        GameCreationResponse duplicateError = testServiceObj.createGame(
                new AuthData(registerAuth.username(), registerAuth.authToken()), "firstGame");
    ...
    public void createGameInvalidAuth(){
        ...
        GameCreationResponse unauthorizedCreate = testServiceObj.createGame(
                new AuthData(registerAuth.username(), registerAuth.authToken()), "firstGame");
    ...
    public void createMultipleGames(){
        ...
        GameCreationResponse game1ID = testServiceObj.createGame(
                new AuthData(registerAuth1.username(), registerAuth1.authToken()), "firstGame");
        GameCreationResponse game2ID = testServiceObj.createGame(
                new AuthData(registerAuth1.username(), registerAuth1.authToken()), "secondGame");
        GameCreationResponse game3ID = testServiceObj.createGame(
                new AuthData(registerAuth1.username(), registerAuth1.authToken()), "thirdGame");
        Assertions.assertEquals(game1ID.gameID(), 1);
        Assertions.assertEquals(game2ID.gameID(), 2);
        Assertions.assertEquals(game3ID.gameID(), 3);
        GameCreationResponse otherGame1ID = testServiceObj.createGame(
                new AuthData(registerAuth2.username(), registerAuth2.authToken()), "newGame");
        GameCreationResponse otherGame2ID = testServiceObj.createGame(
                new AuthData(registerAuth2.username(), registerAuth2.authToken()), "coolGame");
        GameCreationResponse otherGame3ID = testServiceObj.createGame(
                new AuthData(registerAuth2.username(), registerAuth2.authToken()), "finalGame");
        ...
        GameCreationResponse duplicateGame1 = testServiceObj.createGame(
                new AuthData(registerAuth2.username(), registerAuth2.authToken()), "firstGame");
        GameCreationResponse duplicateGame2 = testServiceObj.createGame(
                new AuthData(registerAuth1.username(), registerAuth1.authToken()), "finalGame");
    ...
    public void list1Game(){
        ...
        GameCreationResponse game1ID = testServiceObj.createGame(
                new AuthData(registerAuth.username(), registerAuth.authToken()), "firstGame");
        GameListResponse gameList = testServiceObj.listGames(
    ...
    public void listMultipleGames(){
        ...
        GameListResponse gameList = testServiceObj.listGames(
                new AuthData(registerAuth1.username(), registerAuth1.authToken()));
    ...
    public void blackPlayerJoins(){
        ...
        GameCreationResponse game1ID = testServiceObj.createGame(
                new AuthData(registerAuth.username(), registerAuth.authToken()), "firstGame");
        ErrorResponce blackJoined = testServiceObj.joinGame(
                new AuthData(registerAuth.username(), registerAuth.authToken()),
                ChessGame.TeamColor.BLACK, game1ID.gameID());
